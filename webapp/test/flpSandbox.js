		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Swizoo",
									"targetURL": "#idfoodswizoo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idfoodswizoo-display": {
								"semanticObject": "idfoodswizoo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idfood.swizoo",
									"url": sap.ui.require.toUrl("idfood/swizoo")
								}
							}
						}
					}
